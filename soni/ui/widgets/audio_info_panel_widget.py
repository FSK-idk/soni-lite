...
class AudioInfoPanelWidget(QWidget):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # self.original_release_date_check_box.setText("Show original release date")
        ...
        self.extended_scroll_area.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
